from loaders import DeformRandom
...
data_path_base = '/content/gdrive/My Drive/DeformRandom'
train_dataset = DeformRandom(path_base = data_path_base, list_id='train')
val_dataset = DeformRandom(path_base = data_path_base, list_id='test')
...
if save_test_npy:
    ...
    test_bs = 10
test_dataset = DeformRandom(path_base = data_path_base, list_id='test')
test_partial = 100
